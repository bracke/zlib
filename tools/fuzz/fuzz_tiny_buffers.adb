...
procedure fuzz_tiny_buffers is
   ...
   Target     : constant Zlib.Fuzzing.Target_Kind := Zlib.Fuzzing.Tiny_Buffer_Target;
...
begin
   Ada.Text_IO.Put_Line
     ("target=Tiny_Buffer_Target seed=" & Interfaces.Unsigned_32'Image (Seed) &
