...
procedure fuzz_streaming_inflate is
   ...
   Target     : constant Zlib.Fuzzing.Target_Kind := Zlib.Fuzzing.Streaming_Inflate_Target;
...
begin
   Ada.Text_IO.Put_Line
     ("target=Streaming_Inflate_Target seed=" & Interfaces.Unsigned_32'Image (Seed) &
