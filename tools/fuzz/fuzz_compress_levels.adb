...
procedure fuzz_compress_levels is
   ...
   Target     : constant Zlib.Fuzzing.Target_Kind := Zlib.Fuzzing.Compression_Level_Target;
...
begin
   Ada.Text_IO.Put_Line
     ("target=Compression_Level_Target seed=" & Interfaces.Unsigned_32'Image (Seed) &
