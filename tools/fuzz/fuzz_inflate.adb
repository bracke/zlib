...
procedure fuzz_inflate is
   ...
   Target     : constant Zlib.Fuzzing.Target_Kind := Zlib.Fuzzing.Inflate_Target;
...
begin
   Ada.Text_IO.Put_Line
     ("target=Inflate_Target seed=" & Interfaces.Unsigned_32'Image (Seed) &
