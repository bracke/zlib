...
procedure fuzz_compress_roundtrip is
   ...
   Target     : constant Zlib.Fuzzing.Target_Kind := Zlib.Fuzzing.Compress_Roundtrip_Target;
...
begin
   Ada.Text_IO.Put_Line
     ("target=Compress_Roundtrip_Target seed=" & Interfaces.Unsigned_32'Image (Seed) &
