...
procedure fuzz_gzip_metadata is
   ...
   Target     : constant Zlib.Fuzzing.Target_Kind := Zlib.Fuzzing.GZip_Metadata_Target;
...
begin
   Ada.Text_IO.Put_Line
     ("target=GZip_Metadata_Target seed=" & Interfaces.Unsigned_32'Image (Seed) &
