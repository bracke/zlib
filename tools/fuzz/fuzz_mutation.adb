...
procedure fuzz_mutation is
   ...
   Target     : constant Zlib.Fuzzing.Target_Kind := Zlib.Fuzzing.Mutation_Target;
...
begin
   Ada.Text_IO.Put_Line
     ("target=Mutation_Target seed=" & Interfaces.Unsigned_32'Image (Seed) &
