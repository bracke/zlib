...
procedure fuzz_wrapper_mix is
   ...
   Target     : constant Zlib.Fuzzing.Target_Kind := Zlib.Fuzzing.Wrapper_Mix_Target;
...
begin
   Ada.Text_IO.Put_Line
     ("target=Wrapper_Mix_Target seed=" & Interfaces.Unsigned_32'Image (Seed) &
