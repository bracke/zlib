...
procedure fuzz_dictionary is
   ...
   Target     : constant Zlib.Fuzzing.Target_Kind := Zlib.Fuzzing.Dictionary_Target;
...
begin
   Ada.Text_IO.Put_Line
     ("target=Dictionary_Target seed=" & Interfaces.Unsigned_32'Image (Seed) &
