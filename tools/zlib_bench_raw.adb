...
procedure Zlib_Bench_Raw is
   ...
   Config       : Compression_Config := (Wrapper => Wrapper_Raw, others => <>);
   ...
   begin
      TIO.Put_Line
        ("usage: zlib_bench_raw [--input FILE | --pattern random-ish|repeated|text-like --size BYTES]");
      TIO.Put_Line
