...
procedure Zlib_Bench_Deflate is
   ...
   Config       : Compression_Config := (Wrapper => Wrapper_Zlib, others => <>);
   ...
   begin
      TIO.Put_Line
        ("usage: zlib_bench_deflate [--input FILE | --pattern random-ish|repeated|text-like --size BYTES]");
      TIO.Put_Line
